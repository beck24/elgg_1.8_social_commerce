<?php
	...
	$rating_val = elgg_get_entities_from_metadata('product_guid',$id_sent,'object','rating');
	if(!$rating_val){
	...
	$newtotals = elgg_get_entities_from_metadata('product_guid',$id_sent,'object','rating');
	$numbers = $newtotals[0];
