<?php
	...
	function price_calc_default($products){
		$shipping_settings = elgg_get_entities_from_metadata('shipping_method','default','object','s_shipping',0,1);
	...
	function varyfy_shipping_settings_default(){
		$settings = elgg_get_entities_from_metadata('shipping_method','default','object','s_shipping',0,1);
		if($settings){
			$settings = $settings[0];
