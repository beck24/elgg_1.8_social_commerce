<?php
	...
	// Get objects
		...
		switch($filter){
			...
			break;
			case "transactions":
				/*$cound = elgg_get_entities_from_metadata('trans_category','sold_product','object','transaction',$_SESSION['user']->guid,$limit,$offset,'','',true);
				$transactions = elgg_get_entities_from_metadata('trans_category','sold_product','object','transaction',$_SESSION['user']->guid,$limit,$offset);*/
