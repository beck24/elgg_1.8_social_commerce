<?php
	...
	// Get objects
		...
		if(!$offset)
			$offset = 0;
		$count = elgg_get_entities_from_relationship('wishlist',$_SESSION['user']->guid,'','','','','',$limit,$offset,true);
		$entities = elgg_get_entities_from_relationship('wishlist',$_SESSION['user']->guid,'','','','','',$limit,$offset);
